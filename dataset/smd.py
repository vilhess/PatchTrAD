...
def get_loaders(
    root_dir="data/smd/processed", machine="machine-1-1_", window_size=10, batch_size=32
):

    trainset = SMD(
        mode="train", machine=machine, window_size=window_size, root=root_dir
    )
